...
// If name is a match for the name of a valid candidate,
    for (int i=0; i < candidate_count; i++){
        ...
        //         // loop over to see what's their position and store it
        //     rank ++1;
...
void record_preferences(int ranks[])
{
    // for example , ranks[0] = A person's name, then preference[Aperson][every other person] = number of votes

    // for every i person, as long as j is > i, then preference[i][j] +1
